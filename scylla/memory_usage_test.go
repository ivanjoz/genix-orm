...
func (e complexSchema) GetSchema() TableSchema {
	return TableSchema{
		...
		Keys:      Cols(e.ID),
		Indexes: []Index{
			{Type: TypeLocalIndex, Keys: Cols(e.Code)},
			{Type: TypeLocalIndex, Keys: Cols(e.Reference)},
			{Type: TypeLocalIndex, Keys: Cols(e.CategoryID)},
			{Type: TypeLocalIndex, Keys: Cols(e.WarehouseID)},
...
func (e veryComplexSchema) GetSchema() TableSchema {
	return TableSchema{
		...
		Partition:       e.CompanyID,
		Keys:            Cols(e.ID),
		KeyConcatenated: Cols(e.WarehouseID, e.CategoryID, e.SupplierID),
		Indexes: []Index{
			{Type: TypeLocalIndex, Keys: Cols(e.Code)},
			{Type: TypeLocalIndex, Keys: Cols(e.Reference)},
			{Type: TypeLocalIndex, Keys: Cols(e.CategoryID)},
			{Type: TypeLocalIndex, Keys: Cols(e.WarehouseID)},
			{Type: TypeLocalIndex, Keys: Cols(e.ZoneID)},
			{Type: TypeLocalIndex, Keys: Cols(e.RegionID)},
			{Type: TypeLocalIndex, Keys: Cols(e.SupplierID)},
			{Type: TypeLocalIndex, Keys: Cols(e.BrandID)},
