...
// mondayUnixDayByWeekCode memoizes the week-code -> Monday conversion composite bucketing uses to
// turn week-coded ranges into a contiguous timeline.
var mondayUnixDayByWeekCode = map[int16]int16{}
